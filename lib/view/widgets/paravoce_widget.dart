                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                      Text("Era uma vez", style: TextStyle(fontSize: 16,color: const Color.fromARGB(255, 255, 255, 255)))
                      ,Text("Carlinhos", style: TextStyle(fontSize: 14, color: const Color.fromARGB(255, 255, 255, 255)))
                      ],
                    ),
                  ),
                      ],
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                      Text("FUNK", style: TextStyle(fontSize: 16, color:Color.fromARGB(255, 208, 208, 208)),)
