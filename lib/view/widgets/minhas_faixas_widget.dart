...
class MinhasFaixasWidget extends StatefulWidget {
  MinhasFaixasWidget(
      {super.key,
      required this.id,
  ...
  @override
  State<MinhasFaixasWidget> createState() => _MinhasFaixasWidgetState();
}

class _MinhasFaixasWidgetState extends State<MinhasFaixasWidget> {
                              ...
                              children: [
                                IconButton(
                                  ...
                                  onPressed: () async {
                                    ...
                                    bool request = await removerRepositoryTemp
                                        .removerMusica(widget.id);
                                      ...
                                      showDialog(
                                        ...
                                        builder: (BuildContext context) {
                                          return AlertDialog(
                                            title: Text('Erro'),
                                            content: Text(
                                                'Erro ao excluir a música, tente novamente mais tarde'),
                                            actions: <Widget>[
                                              TextButton(
                                                onPressed: () {
                                                  Navigator.of(context).pop();
